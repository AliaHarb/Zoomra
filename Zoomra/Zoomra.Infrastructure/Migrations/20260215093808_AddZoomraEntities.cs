...
{
    /// <inheritdoc />
    public partial class AddZoomraEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextEligibleDonationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    IsAvailableForEmergency = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RewardRedemptions_AspNetUsers_DonorId",
                        column: x => x.DonorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CurrentUnitsCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_Hospitals_HospitalId",
                        column: x => x.HospitalId,
                        principalTable: "Hospitals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmergencyMatches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmergencyMatches_AspNetUsers_DonorId",
                        column: x => x.DonorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EmergencyMatches_EmergencyRequests_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyMatches_DonorId",
                table: "EmergencyMatches",
                column: "DonorId");

            migrationBuilder.CreateIndex(
                name: "IX_EmergencyMatches_RequestId",
                table: "EmergencyMatches",
                column: "RequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_HospitalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RewardRedemptions_DonorId",
